...
try {
  ...
  $checks = @(
    ...
    @("lib\ui\assignments\teacher_assignment_dialog.dart", "class TeacherAssignmentDialog")
  )
...
Write-Host ""
Write-Host "DONE: ALL RUSSIAN UI LOCALIZATION V5 installed." -ForegroundColor Green
