  ...
  Future<void> _save() async {
    if (widget.previewMode) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: MakeChessLocalizedText('Это пример готовой таблицы. Сохранение отключено.'),
        ),
      );
      return;
    }
    ...
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: MakeChessLocalizedText('Таблица турнира сохранена')),
    );
  }
          ...
          if (editable)
            Positioned(
              ...
              child: FilledButton.icon(
                ...
                label: Text(hasLogo ? 'Сменить логотип' : 'Выбрать логотип'),
              ),
            ),
        ],
      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _prettyCell(76, Text(_buchholzFor(row).toStringAsFixed(1))),
          _prettyCell(76, Text(_bergerFor(row).toStringAsFixed(2))),
          _prettyCell(76, const Text('—')),
          _prettyCell(
            64,
            Text(
              '${_placeFor(row)}',
    ...
    return Container(
      ...
      child: Row(
        children: [
            ...
            Row(
              ...
              children: [
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (_) => const [
                    PopupMenuItem(value: 'edit', child: MakeChessLocalizedText('Редактировать')),
                    PopupMenuItem(value: 'delete', child: MakeChessLocalizedText('Удалить')),
                  ],
                ),
              ],
            ),
          ...
          _cell(105, Text(_buchholzFor(row).toStringAsFixed(2))),
          _cell(105, Text(_bergerFor(row).toStringAsFixed(2))),
          _cell(105, const Text('—')),
          _cell(
            82,
            Text(
              '${_placeFor(row)}',
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text(person.flag, style: const TextStyle(fontSize: 13)),
            ),
          ),
        ],
      ),
    ...
    return _cell(
      ...
      DropdownButtonHideUnderline(
        child: DropdownButton<String?>(
          ...
          isDense: true,
          dropdownColor: _panel2,
          hint: const Text('—', style: TextStyle(color: Colors.white30)),
    ...
    return Row(
      children: [
        OutlinedButton.icon(
          ...
          label: Text(!widget.previewMode && _showPreview
