...
class _PersonalCabinetDialogState extends State<_PersonalCabinetDialog> {
  ...
  Future<void> _connectLichess() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Не удалось подключить Lichess: $error')),
      );
    }
  }
  ...
  Future<void> _editProfile() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: MakeChessLocalizedText('Личные данные сохранены локально')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          const MakeChessLocalizedText('Личный кабинет не загрузился',
              style: AppTextStyles.sectionTitle),
          const SizedBox(height: 12),
          FilledButton(onPressed: _load, child: const MakeChessLocalizedText('Повторить')),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Expanded(
            child: MakeChessLocalizedText('Личный кабинет', style: AppTextStyles.sectionTitle),
          ),
            ...
            return SizedBox(
              ...
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    MakeChessLocalizedText(type.title, style: AppTextStyles.caption),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const MakeChessLocalizedText('Аккаунт Lichess', style: AppTextStyles.body),
                      const SizedBox(height: 3),
                      Text(
  ...
  Future<void> _pickPhoto() async {
    ...
    try {
      ...
      if (file.size > 1500 * 1024) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: MakeChessLocalizedText('Фотография должна быть меньше 1,5 МБ'),
          ),
        );
        return;
      }
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextButton.icon(
                          ...
                          label: const MakeChessLocalizedText('Убрать фотографию'),
                        ),
                        const MakeChessLocalizedText(
              ...
              TextField(
                ...
                maxLines: 5,
                style: AppTextStyles.body,
                decoration: AppInputs.dark(labelText: MakeChessLocalization.phrase('Кратко о себе')),
              ),
            ],
          ),
        ),
