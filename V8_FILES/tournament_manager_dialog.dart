...
class _TournamentManagerDialogState extends State<TournamentManagerDialog> {
  ...
  Future<void> _createCurrentTournamentFromTemplate(
    ...
    await _save();
    // Publishing a tournament must not invite its creator automatically.
    // The creator decides separately whether to join as a player.
  }
                                ...
                                FilledButton.icon(
                                  onPressed: () async {
                                    ...
                                    if (result != null) {
                                      ...
                                      await _updateActive(updated);
                                      // Do not auto-invite the creator after
                                      // publishing. Creator participation is
                                      // an explicit independent action.
                                    }
                                  },
                                  icon: const Icon(Icons.visibility_outlined),
