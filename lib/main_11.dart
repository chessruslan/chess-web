...
Future<void> main() async {
  ...
  // Инициализация Supabase (подставьте свои ключи/URL в secrets.dart)
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      scrollBehavior: const _NoBounceScrollBehavior(), // ← добавили
      home: AppShell(
...
// fen -> код для ассета, и обратно
  ...
  Future<void> _pickBackgroundImage() async {
    ...
    if (result != null &&
      ...
      setState(() {
        _backgroundBytes = result.files.single.bytes; // сохраняем в память
      });
    }
  }
