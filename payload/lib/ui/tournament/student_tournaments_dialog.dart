...
class _StudentTournamentsDialogState extends State<_StudentTournamentsDialog> {
  ...
  Future<void> _callTournament(Map<String, dynamic> tournament) async {
    ...
    final minutes = await showDialog<int>(
      ...
      builder: (dialogContext) => AlertDialog(
        title: MakeChessLocalizedText(MakeChessLocalization.phrase('Вызвать участников')),
        content: TextField(
        ...
        actions: [
          TextButton(
            ...
            child: MakeChessLocalizedText(MakeChessLocalization.phrase('Отмена')),
          ),
          FilledButton(
            ...
            child: MakeChessLocalizedText(MakeChessLocalization.phrase('Отправить')),
          ),
        ],
      ),
    );
  ...
  Future<void> _openTournament(Map<String, dynamic> tournament) async {
    ...
    await showTournamentTableEditor(
      ...
      onParticipate: !owner && !_isParticipant(tournament)
  ...
  Future<void> _requestParticipation(Map<String, dynamic> tournament) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: MakeChessLocalizedText(
          result == 'joined'
              ? MakeChessLocalization.phrase('Вы добавлены в турнирную таблицу')
              : result == 'owner'
                  ? MakeChessLocalization.phrase(
                      'Вы являетесь создателем турнира')
                  : MakeChessLocalization.phrase(
  ...
  Widget _header() => Container(
        ...
        child: Row(
          children: [
            ...
            MakeChessLocalizedText(MakeChessLocalization.phrase(widget.dialogTitle),
                style:
      ...
      child: Column(
        children: [
          ...
          FilledButton.icon(
            ...
            label: MakeChessLocalizedText(MakeChessLocalization.phrase('Игровая платформа')),
          ),
        ],
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            FilledButton.icon(
              ...
              label: MakeChessLocalizedText(MakeChessLocalization.phrase('Повторить')),
            ),
          ],
        ),
      );
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Row(
                          children: [
                            ...
                            if (current)
                              FilledButton.icon(
                                onPressed: owned || joined
                                    ? () => _openTournament(t)
                                    : () => _requestParticipation(t),
                                icon: Icon(owned || joined
