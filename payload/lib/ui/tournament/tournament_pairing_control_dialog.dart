            ...
            child: const Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Expanded(child: MakeChessLocalizedText('Управление жеребьёвкой')),
                  ...
                  children: [
                    ...
                    if (_settings.mode == TournamentPairingMode.manual)
                      OutlinedButton.icon(
                        ...
                        label: const MakeChessLocalizedText('Составить пары вручную'),
                      ),
                    FilledButton.icon(
            ...
            children: [
              DropdownButtonFormField<int>(
                ...
                decoration: InputDecoration(
                  labelText: MakeChessLocalization.phrase('Количество полных кругов'),
                ),
              ...
              DropdownButtonFormField<int>(
                ...
                decoration: InputDecoration(
                  labelText: MakeChessLocalization.phrase('Партий с одним соперником'),
                ),
                items: List<int>.generate(10, (index) => index + 1)
                    .map((count) => DropdownMenuItem<int>(
                          value: count,
              ...
              DropdownButtonFormField<int>(
                ...
                decoration: InputDecoration(
                  labelText: MakeChessLocalization.phrase('Пауза перед следующим туром'),
                ),
