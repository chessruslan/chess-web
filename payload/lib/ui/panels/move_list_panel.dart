          ...
          child: Column(
            ...
            children: [
              MakeChessLocalizedText(
                MakeChessLocalization.text(MakeChessTextKey.moves),
                style: compact
              ...
              if (compact) ...[
                AppNeoButton(
                  text: MakeChessLocalization.text(MakeChessTextKey.copyPgn),
                  icon: Icons.copy_all,
              ...
              children: [
                Expanded(
                  child: _TinyAnswerNavButton(
                    ...
                    text: 'Назад',
                    onTap:
                        hasLines && correctLines.length > 1 ? onPrevious : null,
                  ),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _TinyAnswerNavButton(
                    ...
                    text: 'Вперёд',
                    onTap: hasLines && correctLines.length > 1 ? onNext : null,
                  ),
                ),
              ],
            ),
