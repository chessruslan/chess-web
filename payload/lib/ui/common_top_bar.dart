    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (_) => [
        PopupMenuItem<String>(
          ...
          child: ListTile(
            ...
            title: MakeChessLocalizedText(MakeChessLocalization.text(MakeChessTextKey.playHere),
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            MakeChessLocalizedText(MakeChessLocalization.text(MakeChessTextKey.play),
      ...
      itemBuilder: (_) => [
        ...
        PopupMenuItem<String>(
          ...
          child: ListTile(
            ...
            title: MakeChessLocalizedText(MakeChessLocalization.text(MakeChessTextKey.school),
                style: AppTextStyles.body),
          ),
        ),
      ],
        ...
        child: ValueListenableBuilder<String>(
          ...
          builder: (context, value, child) {
            ...
            return Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                MakeChessLocalizedText(label, style: AppTextStyles.topBarButton),
                const SizedBox(width: 4),
                const Icon(
              ...
              children: [
                          ...
                          children: [
                            Expanded(
                              child: TextButton.icon(
                                ...
                                label: MakeChessLocalizedText(MakeChessLocalization.text(
                ...
                Padding(
                  ...
                  child: ValueListenableBuilder<String>(
                    ...
                    builder: (context, value, child) {
                      final label = _makechessCoreLearningLabel(value);
                      return MakeChessLocalizedText(label, style: AppTextStyles.caption);
                    },
                  ),
                ),
                item(
                      ...
                      return DropdownMenuItem<String>(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            MakeChessLocalizedText(kLanguageLabels[lang] ?? lang),
                          ],
                        ),
                      );
                    }).toList(),
