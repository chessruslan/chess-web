          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Поле 1: список школ
                MakeChessLocalizedText('Школа', style: theme.textTheme.labelLarge),
                ...
                // Поле 2: избранные
                MakeChessLocalizedText('Избранное', style: theme.textTheme.labelLarge),
                const SizedBox(height: 8),
                _LinedDropdown<String>(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                MakeChessLocalizedText(rating, style: theme.textTheme.bodyMedium),
              ],
            ),
          ),
        ],
