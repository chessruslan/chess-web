  ...
  Future<void> _deleteTournament(_TournamentData tournament) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('«${tournament.name}» будет удалён из этого браузера.'),
        actions: [
          TextButton(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 150,
            child: MakeChessLocalizedText(label, style: const TextStyle(color: Colors.white54)),
          ),
          Expanded(
            child: Text(
              value,
          ...
          Row(
            ...
            children: [
              ...
              FilledButton.icon(
                ...
                label: const MakeChessLocalizedText('Создать турнир по шаблону'),
              ),
            ],
          ),
        ],
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            labelText: MakeChessLocalization.phrase('Через сколько минут начнётся турнир'),
            suffixText: 'мин.',
          ),
        ),
        actions: [
                            ...
                            child: Row(
                              children: [
                                ...
                                FilledButton.icon(
                                  ...
                                  icon: const Icon(Icons.visibility_outlined),
                                  label: const MakeChessLocalizedText('Открыть турнир'),
                                ),
                                ...
                                OutlinedButton(
                                  ...
                                  child: const MakeChessLocalizedText('Управление'),
                                ),
                                IconButton(
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: MakeChessLocalization.phrase('Поиск школы или учителя'),
                ),
              ),
            ),
            ConstrainedBox(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  tooltip: expanded ? 'Скрыть состав' : 'Показать состав',
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    isDense: true,
                    prefixIcon: Icon(Icons.search, size: 18),
                    hintText: MakeChessLocalization.phrase('Поиск ученика или сотрудника'),
                  ),
                ),
              ),
                ...
                Row(
                  children: [
                    FilledButton.icon(
                      ...
                      label: Text(active.pairings.isEmpty
                          ? 'Сформировать пары'
                          : 'Пережеребить'),
                    ),
                    const SizedBox(width: 10),
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 6),
                      IconButton(
                        tooltip: MakeChessLocalization.phrase('Скопировать как новый шаблон'),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          MakeChessLocalizedText(text, style: const TextStyle(color: Colors.white54)),
        ],
      ),
    );
  }
