...
$Backup = Join-Path $Root ("_backup_electronic_board_camera_grid_v1_" + $Stamp)
$ResultLog = Join-Path $Root "MAKECHESS_ELECTRONIC_BOARD_CAMERA_GRID_V1_RESULT.txt"
$BuildLog = Join-Path $Root "MAKECHESS_ELECTRONIC_BOARD_CAMERA_GRID_V1_BUILD.log"
...
try {
    Write-Host "=========================================================="
    Write-Host "MAKECHESS - ELECTRONIC BOARD CAMERA + GRID V1"
    ...
    Write-Host ""
    Write-Host "=========================================================="
    Write-Host "MAKECHESS_ELECTRONIC_BOARD_CAMERA_GRID_V1_OK"
    Write-Host "=========================================================="
    ...
    @(
        "MAKECHESS_ELECTRONIC_BOARD_CAMERA_GRID_V1_ERROR"
        "Error: $message"
        "Backup: $Backup"
        "Rollback attempted."
        "No publish was performed."
    ...
    Write-Host ""
    Write-Host "=========================================================="
    Write-Host "MAKECHESS_ELECTRONIC_BOARD_CAMERA_GRID_V1_ERROR"
